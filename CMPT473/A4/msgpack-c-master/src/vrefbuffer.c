...
// // !!!!!!!!!!!!!!!!
// extern "C" int LLVMFuzzerTestOneInput(msgpack_vrefbuffer* vbuf,
//         size_t ref_size, size_t chunk_size, const char* buf) {
//     // msgpack_vrefbuffer_init(vbuf, ref_size, chunk_size);
//     // msgpack_vrefbuffer_destroy(vbuf);
//     // msgpack_vrefbuffer_clear(vbuf);
//     msgpack_vrefbuffer_append_ref(vbuf, buf, chunk_size);
//     return 0;
// }
