...
// // !!!!!!!!!!!!!!!!
// extern "C" int LLVMFuzzerTestOneInput(char *buffer, size_t buffer_size, msgpack_object o, FILE* out) {
//     msgpack_object_print_buffer(buffer, buffer_size, o);
//     //msgpack_object_print(out, o);
//     return 0;
// }
