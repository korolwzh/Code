...
def depthFirstSearch(problem):
    ...
    while not fringe.isEmpty():
        ...
        for coordinate, action, cost in problem.getSuccessors(node):
            if coordinate not in visited:
                fringe.push((coordinate, path + [action]))
    ...
    while not problem.isGoalState(state):
        ...
        for son in successors:
            ...
            if not visitedExist:
                ...
                visited.append((son[0], toCost + son[2]))  # add this point to visited list
...
"""
For this assignment I spend over 20 hours on it, mostly for the question2.
And I can't solve the question2.2.
